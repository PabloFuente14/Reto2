...
class Cliente (models.Model):
    ...
    def __str__(self):
        return f"cif: {self.cif}, nombre: {self.nombre}, direccion: {self.direccion}, cp: {self.cp}, ciudad: {self.ciudad}, provincia: {self.provincia}, telefono: {self.telefono}, correo: {self.correo}"
